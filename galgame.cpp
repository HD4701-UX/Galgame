    ...
    m_inDialogue(false)
{
    ...
    bgmOutput->setVolume(0.5);                       // 音量 0~1
    bgmPlayer->setLoops(QMediaPlayer::Infinite);     // 循环播放


    // 1. 背景图片标签（覆盖整个窗口，作为底层背景）
    backgroundLabel = new QLabel(this);
    backgroundLabel->setScaledContents(true);   // 图片自动缩放以适应标签
    backgroundLabel->setGeometry(0, 0, width(), height());
    backgroundLabel->lower();                   // 置于最底层

    // 2.文本显示区域
    textDisplay = new QTextEdit(this);
    textDisplay->setReadOnly(true);
    textDisplay->setStyleSheet("font-size: 14px; font-family: 'Microsoft YaHei';"
                               "background-color:rgba(0,0,0,100);"  //半透明黑底
                               "color: white;"
                               "border: none;");
    ...
    // 4.布局：图片作为背景占据整个窗口，文字和按钮悬浮在上层
    mainLayout = new QVBoxLayout(this);
    mainLayout->addWidget(textDisplay,0,Qt::AlignCenter);
...
// 切换背景图片的函数
void GameWindow::setBackgroundImage(const QString &imagePath) {
...
// 在 updateUI() 中添加图片切换逻辑

void GameWindow::playBGM(const QString &filePath)
{
    bgmPlayer->setSource(QUrl::fromLocalFile(filePath));
    bgmPlayer->play();

}

void GameWindow::stopBGM()
{
    bgmPlayer->stop();
}
...
void GameWindow::updateUI()
{
    ...
    switch (currentState) {
    case S_START:
        playBGM("C:/Users/孟杋洋/Desktop/galgame分镜/萤火之森.mp3");
        setBackgroundImage("C:/Users/孟杋洋/Desktop/galgame分镜/分镜1.png");    // 标题画面背景
        textDisplay->setText(
    ...
    case S_TRANSFER_ASK:
        setBackgroundImage("C:/Users/孟杋洋/Desktop/galgame分镜/分镜2.png");
        textDisplay->setText(
    ...
    case S_AFTER_ACCEPT:
        setBackgroundImage("C:/Users/孟杋洋/Desktop/galgame分镜/分镜3.png");
        textDisplay->setText(
            "\"当然可以啦。\" 你望着面前的同学说道。\n"
            "\"谢谢同学，以后请多关照哦...\"\n");
        continueButton->show();
    ...
    case S_SUNLIGHT:
        setBackgroundImage("C:/Users/孟杋洋/Desktop/galgame分镜/分镜4.png");
        textDisplay->setText(
    ...
    case S_NEED_HELP:
        setBackgroundImage("C:/Users/孟杋洋/Desktop/galgame分镜/分镜6.png");
        textDisplay->setText(
    ...
    // 假设原 S_EVENING_HOME 改成多个状态：
    case S_EVENING_PART1:
        setBackgroundImage("C:/Users/孟杋洋/Desktop/galgame分镜/分镜9.png");
        textDisplay->setText("一个平常的夜晚，你照常上完晚自习准备回家，独处的你早就习惯了一个人走着空寂的巷子。");
        continueButton->show();
        break;

    case S_EVENING_PART2_IF_HIGH:
        setBackgroundImage("C:/Users/孟杋洋/Desktop/galgame分镜/分镜10.png");
        textDisplay->setText("但这一次，沈冰悦叫住了你。\n\n\"那个...我记得你家是在镇上住吧...我家也在那里，要不要一起回去？\" 她微微低着头，发梢遮住了她的眼睛，却遮不住她内心的羞涩。");
        continueButton->show();
        break;

    case S_EVENING_PART3:
        setBackgroundImage("C:/Users/孟杋洋/Desktop/galgame分镜/分镜11.png");
        textDisplay->setText("你看着眼前的羞涩的她，内心不由得生起一丝心动...");
        continueButton->show();
        break;
        // ... 然后按“继续”时根据好感度跳转到对应状态
     case S_EVENING_HOME:
        setBackgroundImage("C:/Users/孟杋洋/Desktop/galgame分镜/分镜12（第一章结束）.png");
        textDisplay->setText("Level 1 Complete!");
        continueButton->show();
        break;
     case S_EVENING_PART2_LOW:
         textDisplay->setText("以后会不会有什么变化呢...");
         continueButton->show();
         break;
     case S_EVENING_BEHOME:
         setBackgroundImage("C:/Users/孟杋洋/Desktop/galgame分镜/分镜12（坏结局）.png");
         textDisplay->setText("Level 1 Complete!");
         continueButton->show();
         break;
    ...
    case S_LV2_HIGH_FAVOR:
        setBackgroundImage("C:/Users/孟杋洋/Desktop/galgame分镜/分镜13.png");
        textDisplay->setText("你走在寂静的巷子中，不同以往的是，你的身边多了一个女生...");
        continueButton->show();
        break;
        //加分镜13

    case S_LV2_HIGH_FAVOR_PART2:
        setBackgroundImage("C:/Users/孟杋洋/Desktop/galgame分镜/分镜14.png");
        textDisplay->setText("天津的春天比以往的任何时候都要更冷一些,她唇间呼出的水汽蒸腾在昏黄的路灯下，渐渐地，渐渐地，消失在夜色之中。\n"
                             "\"是不是有点冷？\" 你看着身边的沈冰悦，缓缓开口道。\n"
                             "\"哦哦，没事的，谢谢你的关心。\" 她的手凑近了脸，利用呼出的余温让手暖和一些。\n"
                             "你们在路上有一句没一句的聊天，你开始对她有一定的了解了，但似乎今天的路程比平时要短上不少,"
                             "很快你便看到了不远处熟悉的灯火。\n"
    ...
    case S_LV2_HIGH_FAVOR_PART3:
        setBackgroundImage("C:/Users/孟杋洋/Desktop/galgame分镜/分镜15.png");
        textDisplay->setText("\"这样啊...\" 她的脸似乎僵住了。\n\"那个...\" 像是被什么东西咽住了，沈冰悦有些手足无措。\n"
                             "\"怎么了吗？\"\n"
                             "\"那个...关于上课的事情...谢谢你...\" 她脸有些微微发烫，显得很是可人。\n"
                             "\"没事没事，‘举手’之劳。\"\n"
                             "\"那...明天再见。\"\n 她留下一句话，就自己跑开了...后面的事你就记不清了，只记得那个晚上，她真的很漂亮。");
        continueButton->show();
        break;
        //加分镜15
    ...
    {
        setBackgroundImage("C:/Users/孟杋洋/Desktop/galgame分镜/分镜16.png");
        // 根据好感度添加不同语句
        //加分镜16（两个状态图片都一样）
        if (favorability >= 50) {
            textDisplay->setText(">>第二天早上\n"
    ...
    case S_LV2_NEXT_MORNING_PART2:
        setBackgroundImage("C:/Users/孟杋洋/Desktop/galgame分镜/分镜17.png");
        textDisplay->setText("沈冰悦进入了教室，看起来，她比往常更加的漂亮了。"
                             "教室中男生的喧闹声随着她的经过变得逐渐安静，"
                             "男生们面面相觑，彼此心照不宣，几秒钟之后，却又开始笑话起彼此了。");
        continueButton->show();
        break;
        //加分镜17

    case S_LV2_NEXT_MORNING_PART3:
        setBackgroundImage("C:/Users/孟杋洋/Desktop/galgame分镜/分镜18.png");
        textDisplay->setText("沈冰悦走到我的面前，指甲轻触实木课桌，淡淡却又难以寻味的说：\"早上好啊...\" "
                             "你礼貌性的回复了她，却不由得多想一些了...\n");
        continueButton->show();
        break;
        //加分镜18
...
void GameWindow::onContinueClicked()
{
    ...
    case S_POST_CHOICE_COMMON:setState(S_EVENING_PART1); break;
    case S_EVENING_PART1:
        if (favorability >= 50)
            setState(S_EVENING_PART2_IF_HIGH);
        else
            setState(S_EVENING_PART2_LOW);  // 对应“以后说不定有什么变化”
        break;
    case S_EVENING_PART2_IF_HIGH://沈冰悦叫人
        setState(S_EVENING_PART3);
        break;
    case S_EVENING_PART3://男主心动
        setState(S_EVENING_HOME);
        break;
    case S_EVENING_PART2_LOW://独自回家
        setState(S_EVENING_BEHOME);
        break;
    case S_EVENING_BEHOME://进入level 2判定
        setState(S_LOADING_LEVEL2);
        break;
    case S_EVENING_HOME:
        setState(S_LOADING_LEVEL2);
        break;
    case S_LOADING_LEVEL2:
        ...
        break;
    case S_LV2_HIGH_FAVOR:
        setState(S_LV2_HIGH_FAVOR_PART2);
        break;
    case S_LV2_HIGH_FAVOR_PART2:
        setState(S_LV2_HIGH_FAVOR_PART3);
        break;
    case S_LV2_HIGH_FAVOR_PART3:
        setState(S_LV2_NEXT_MORNING);
        break;
    case S_LV2_NEXT_MORNING:
        setState(S_LV2_NEXT_MORNING_PART2);
        break;
    case S_LV2_NEXT_MORNING_PART2:
        setState(S_LV2_NEXT_MORNING_PART3);
        break;
    case S_LV2_NEXT_MORNING_PART3:
        setState(S_END);
        break;
...
void GameWindow::onOption1Clicked()
{
    if (currentState == S_FIRST_CHOICE) {
        ...
        favorability += 5;
         setBackgroundImage("C:/Users/孟杋洋/Desktop/galgame分镜/分镜7（主动请缨）.png");
        textDisplay->setText(
            "\"我可以给你补。\" 你不假思索的对沈冰悦说道。\n"
            "\"啊...谢谢...\"\n");
...
void GameWindow::onOption2Clicked()
{
    if (currentState == S_FIRST_CHOICE) {
        ...
        favorability += 20;
        setBackgroundImage("C:/Users/孟杋洋/Desktop/galgame分镜/分镜8（旁敲侧击）.png");
        textDisplay->setText(
